...
export const BackgroundCircles = ({ parallaxRef }:{parallelRef:Function}) => {
    ...
    return (
      <div className="absolute -top-[42.375rem] left-1/2 w-[78rem] aspect-square border border-white/10 rounded-full -translate-x-1/2 md:-top-[38.5rem] xl:-top-[32rem]">
        <Rings />
